...
import { LayoutDashboard, BookOpen, Book, Headphones, Users, CreditCard, Settings, LogOut, Menu, X, Upload, Activity, Plus } from 'lucide-react';
...
const NAV = [
  ...
  { to: '/admin/coupons',     icon: Plus,            label: 'Coupons' },
